Hemos hecho uso de estas evaluaciones \textit{offline} para comparar distintas estrategias de agregación. Así seremos
...
\begin{figure}[Gráficas de similitud entre estrategias para un grupo de 2 personas con similitud en semillas]{FIG:GRAFICAS_PAREJA_SIMILITUD}
    ...
    \subfigure[]{\textit{Average}}{\image{7cm}{}{graficas/average_2_coincidence.png}}
    \subfigure[]{\textit{Average Custom}}{\image{7cm}{}{graficas/custom_2_coincidence.png}}
    \subfigure[]{\textit{Borda}}{\image{7cm}{}{graficas/borda_2_coincidence.png}}
    \subfigure[]{\textit{Least Misery}}{\image{7cm}{}{graficas/misery_2_coincidence.png}}
    \subfigure[]{\textit{Most Pleasure}}{\image{7cm}{}{graficas/pleasure_2_coincidence.png}}
    \subfigure[]{\textit{Multiplicative}}{\image{7cm}{}{graficas/multiplicative_2_coincidence.png}}
\end{figure}
...
\begin{figure}[Gráficas de similitud entre estrategias para un grupo de 3 personas sin similitud en semillas]{FIG:GRAFICAS_TRIO_NO_SIMILITUD}
    ...
    \subfigure[]{\textit{Average}}{\image{7cm}{}{graficas/average_3_no_coincidence.png}}
    \subfigure[]{\textit{Average Custom}}{\image{7cm}{}{graficas/custom_3_no_coincidence.png}}
    \subfigure[]{\textit{Borda}}{\image{7cm}{}{graficas/borda_3_no_coincidence.png}}
    \subfigure[]{\textit{Least Misery}}{\image{7cm}{}{graficas/misery_3_no_coincidence.png}}
    \subfigure[]{\textit{Most Pleasure}}{\image{7cm}{}{graficas/pleasure_3_no_coincidence.png}}
    \subfigure[]{\textit{Multiplicative}}{\image{7cm}{}{graficas/multiplicative_3_no_coincidence.png}}
\end{figure}
